          ...
          <div className="space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {availableColors.map((col) => (
                    <button
                      ...
                      className={`px-4 py-1.5 rounded-lg border-2 text-sm font-medium transition-all ${selectedColor === col
                ...
                <div className="flex flex-wrap gap-2">
                  {availableSizes.map((size) => (
                    <button
                      ...
                      className={`px-4 py-1.5 rounded-lg border-2 text-sm font-medium transition-all min-w-[52px] text-center ${selectedSize === size
                          ? "border-[#111] bg-[#111] text-white"
                          : "border-gray-200 hover:border-gray-400 text-[#1c1d1d]"
                        }`}
                    >
            ...
            <div className="border-t border-gray-100 pt-4 flex items-center justify-between gap-4">
              ...
              <div className="text-right">
                <span
                  className={`inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-full ${inStock
            ...
            <div className="space-y-3 pt-1">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={`flex-1 py-3.5 px-3 rounded-xl font-bold text-xs sm:text-sm transition-all flex items-center justify-center gap-2 active:scale-95 ${inStock
              ...
              <button
                ...
                className="w-full py-3 px-3 rounded-xl font-bold text-xs sm:text-sm bg-emerald-500 hover:bg-emerald-600 text-white transition-all flex items-center justify-center gap-2 active:scale-95"
              >
              ...
              <button
                ...
                className="w-full py-3 px-3 rounded-xl font-bold text-xs sm:text-sm bg-[#25D366] hover:bg-[#1ebe57] text-white transition-all flex items-center justify-center gap-2 active:scale-95"
              >
              ...
              <button
                ...
                className="w-full py-3 px-3 rounded-xl font-bold text-xs sm:text-sm bg-[#0084FF] hover:bg-[#006fd6] text-white transition-all flex items-center justify-center gap-2 active:scale-95"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
