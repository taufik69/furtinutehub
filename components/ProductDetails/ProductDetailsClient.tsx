        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 mb-16">
          ...
          <div className="space-y-5">
            ...
            <div className="border-t border-gray-100 pt-4 flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-[#1c1d1d] mb-2">
                  Quantity
                </p>
            ...
            <div className="space-y-3 pt-1">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={`flex-1 py-3.5 px-3 rounded-xl font-bold text-xs sm:text-sm transition-all flex items-center justify-center gap-2 active:scale-95 ${
                    inStock
            ...
            {product?.description && (
              <div className="border-t border-gray-100 pt-5">
                <h3 className="text-base font-bold text-[#1c1d1d] mb-2">
                  Description
                </h3>
            ...
            <div className="border-t border-gray-100 pt-5 space-y-2">
              <h3 className="text-base font-bold text-[#1c1d1d] mb-3">
                Product Details
              </h3>
              {[
                { label: "SKU", value: sku },
                ...
                .map((row) => (
                  ...
                  >
                    ...
                    <span className="text-[#1c1d1d] font-semibold">
                      {row.value}
                    </span>
                  </div>
                ))}
            ...
            <div className="border-t border-gray-100 pt-4 grid grid-cols-2 gap-3">
              <div className="flex items-start gap-2.5 p-3 bg-gray-50 rounded-xl">
                ...
                <div>
                  <p className="text-xs font-bold text-[#1c1d1d]">
                    Fastest Delivery
                  </p>
